        ...
        return cls(
            {
                ...
                "rfm_baseline": UpliftFeatureRecipeSpec(
                    source_tables=["clients", "purchases"],
                    feature_groups=["demographic", "rfm", "basket", "points"],
                    windows_days=[30, 60, 90],
                    temporal_policy="pre_issue_only",
                    semantic_name="rfm_baseline",
                    builder_version="v1",
                ),
                "human_semantic_v1": UpliftFeatureRecipeSpec(
                    source_tables=["clients", "purchases"],
                    feature_groups=[
                        "demographic",
                        "age_buckets",
                ...
                "hybrid_safe_semantic_v1": UpliftFeatureRecipeSpec(
                    source_tables=["clients", "purchases"],
                    feature_groups=[
                        "demographic",
                        "age_buckets",
                    ...
                    semantic_name="hybrid_safe_semantic_v1",
                    builder_version="v2",
                ),
